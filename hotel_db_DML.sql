...
CREATE INDEX IDX_ROOM_GuestID ON ROOM (Guest_ID);
...
CREATE INDEX IDX_INVENTORY_GuestID ON INVENTORY (Guest_ID);
...
CREATE TABLE SEQ_PaymentID (
	id INT NOT NULL PRIMARY KEY,
    next_val INT NOT NULL
);

INSERT INTO SEQ_PaymentID (id, next_val) VALUES (1, 99);

DROP TABLE IF EXISTS SEQ_ItemID;
CREATE TABLE SEQ_ItemID (
    id INT NOT NULL PRIMARY KEY,
    next_val INT NOT NULL
);
INSERT INTO SEQ_ItemID (id, next_val) VALUES (1, 99);

DELIMITER $$

-- 신규 결제 레코드 생성 시 Payment_ID를 1씩 자동 증가
...
-- 신규 상품 레코드 생성 시  Item_ID를 1씩 자동 증가
CREATE TRIGGER TRG_INVENTORY_AUTO_ID
BEFORE INSERT ON INVENTORY
FOR EACH ROW
BEGIN
    IF NEW.Item_id IS NULL OR NEW.Item_id = '' THEN
        UPDATE SEQ_ItemID SET next_val = LAST_INSERT_ID(next_val + 1) WHERE id = 1;
        SET NEW.Item_id = LAST_INSERT_ID();
    END IF;
END$$

-- 결제가 발생하면 투숙객의 로열티 포인트를 자동 적립 (10달러당 1포인트)
...
-- 결제 금액이 음수로 들어오는 것을 방지
CREATE TRIGGER TRG_PAYMENT_VALIDATE
BEFORE INSERT ON PAYMENT
FOR EACH ROW
BEGIN
    IF NEW.Payment_amt < 0 THEN
        SIGNAL SQLSTATE '45000' -- 의도적으로 에러를 발생시켜 작업(INSERT/UPDATE 등)을 중단시키는 명령어
        SET MESSAGE_TEXT = 'Payment amount cannot be negative';
    END IF;
END$$

-- 체크아웃 날짜가 체크인 날짜보다 빠르면 삽입 차단
CREATE TRIGGER TRG_ROOM_DATE_VALIDATE
...
-- NOTE: TRG_PAYMENT_VALIDATE, TRG_ROOM_DATE_VALIDATE 트리거가 생성된 이후이므로
-- 아래 EMPLOYEE 데이터부터는 트리거 검증을 통과하는 값들로 구성되어 있습니다.
...
(NULL,'12345678' ,'Card', '2023-05-20', '300.00', '86559' ),
(NULL,'23456789' ,'Cash', '2023-05-01', '250.00','86559' ),
(NULL,'13456789','Card', '2023-05-09', '500.00','86559' ),
(NULL,'14567890' ,'Card', '2023-05-21', '300.00','86559' ),
(NULL,'10234566' ,'Card', '2023-05-14', '300.00','86559' ),
(NULL,'34567890' ,'Card', '2023-05-02', '250.00','86559' ),
(NULL,'45678901' ,'Card', '2023-05-18', '250.00','86559' ),
(NULL,'56789012' ,'Card', '2023-05-30', '300.00','86559' ),
(NULL,'67890123' ,'Card', '2023-05-03', '300.00','86559' ),
(NULL,'78901234' ,'Card', '2023-05-07', '300.00','86559' ),
(NULL,'89012345' ,'Card', '2023-05-02', '500.00','86559' ),
(NULL,'90123456' ,'Card', '2023-05-08', '300.00','86559'),
(NULL,'15678901' ,'Card', '2023-05-27', '300.00','86559' ),
(NULL,'87654321' ,'Card', '2023-05-10', '300.00', '35617' ),
(NULL,'17890123' ,'Card', '2023-05-13', '1000.00','35617' ),
(NULL,'25678901' ,'Card', '2023-05-03', '300.00', '35617'),
(NULL,'19012345' ,'Card', '2023-05-29', '300.00', '35617'),
(NULL,'38459281' ,'Card', '2023-05-05', '300.00', '35617'),
(NULL,'25678902' ,'Card', '2023-05-29', '300.00', '35617'),
(NULL,'28901234' ,'Card', '2023-05-22', '500.00', '35617'),
(NULL,'29012345' ,'Card', '2023-05-13', '300.00', '35617'),
(NULL,'31234567' ,'Card', '2023-05-21', '500.00', '58039'),
(NULL,'32345678' ,'Card', '2023-05-30', '300.00', '58039'),
(NULL,'33456789' ,'Card', '2023-05-20', '300.00', '58039'),
(NULL,'35678901' ,'Card', '2023-05-13', '300.00','58039' ),
(NULL,'36789012' ,'Card', '2023-05-15', '300.00','58039' ),
(NULL,'37890123' ,'Debit', '2023-05-08', '300.00', '58039'),
(NULL,'38901234' ,'Card', '2023-05-01', '300.00', '58039'),
(NULL,'39012345' ,'Card', '2023-05-15', '300.00','29771'),
(NULL,'41234567' ,'Card', '2023-05-29', '250.00','29771' ),
(NULL,'42345678','Debit', '2023-05-07', '300.00', '29771'),
(NULL,'43456789','Card', '2023-05-24', '300.00','29771' ),
(NULL,'44567890' ,'Card', '2023-05-04', '300.00','29771' ),
(NULL,'46789012' ,'Card', '2023-05-22', '300.00', '29771'),
(NULL,'47890123' ,'Card', '2023-05-10', '300.00', '29771'),
(NULL,'48901234' ,'Card', '2023-05-19', '250.00', '29771'),
(NULL,'49012345' ,'Card', '2023-05-11', '300.00', '29771'),
(NULL,'51234567' ,'Card', '2023-05-28', '300.00', '29771'),
(NULL,'52345678','Card', '2023-05-20', '300.00','29771' ),
(NULL,'53456789','Card', '2023-05-02', '1000.00', '29771'),
(NULL,'54678901' ,'Card', '2023-05-14', '300.00', '29771'),
(NULL,'55789012' ,'Card', '2023-05-15', '500.00', '29771'),
(NULL,'57890123' ,'Card', '2023-05-17', '300.00','29771' ),
(NULL,'58901234','Card', '2023-05-05', '300.00', '29771'),
(NULL,'59012334' ,'Card', '2023-05-05', '250.00', '12893'),
(NULL,'60123456' ,'Card', '2023-05-06', '300.00', '12893'),
(NULL,'61234567' ,'Card', '2023-05-21', '300.00', '12893'),
(NULL,'62345678' ,'Card', '2023-05-11', '300.00', '12893'),
(NULL,'63456789' ,'Debit', '2023-05-08', '75.00', '12893'),
(NULL,'64567890' ,'Card', '2023-05-28', '300.00', '12893');
...
(NULL, '1', "text", '12345678'),
(NULL, '1', "CASH", '23456789'),
(NULL, '2', "Credit", '13456789'),
(NULL, '7', "Credit", '14567890'),
(NULL, '5', "Credit", '10234566'),
(NULL, '1', "Credit", '34567890'),
(NULL, '2', "CASH", '45678901'),
(NULL, '9', "CASH", '56789012'),
(NULL, '7', "Debit", '67890123'),
(NULL, '8', "Debit", '78901234'),
(NULL, '5', "CASH", '64567890'),
(NULL, '3', "Credit", '64567890'),
(NULL, '6', "Credit", '63456789'),
(NULL, '5', "CASH", '63456789'),
(NULL, '7', "text", '62345678'),
(NULL, '3', "CASH", '61234567'),
(NULL, '9', "Debit", '60123456'),
(NULL, '10', "Debit", '59012334'),
(NULL, '2', "Debit", '59012334'),
(NULL, '3', "Credit", '58901234'),
(NULL, '6', "Debit", '58901234'),
(NULL, '3', "Credit", '57890123'),
(NULL, '1', "Credit", '55789012'),
(NULL, '1', "Cash", '54678901'),
(NULL, '1', "Credit", '53456789'),
(NULL, '4', "Cash", '52345678'),
(NULL, '5', "Credit", '51234567'),
(NULL, '3', "Credit", '49012345'),
(NULL, '2', "Text", '48901234'),
(NULL, '4', "Credit", '47890123'),
(NULL, '3', "Credit", '46789012'),
(NULL, '5', "Cash", '44567890'),
(NULL, '2', "Credit", '43456789'),
(NULL, '1', "Debit", '43456789'),
(NULL, '2', "Debit", '42345678'),
(NULL, '2', "Debit", '41234567'),
(NULL, '2', "Debit", '39012345'),
(NULL, '1', "Credit", '38901234'),
(NULL, '1', "Cash", '37890123'),
(NULL, '15', "Cash", '36789012'),
(NULL, '4', "Cash", '35678901'),
(NULL, '8', "Credit", '35678901'),
(NULL, '7', "Text", '33456789'),
(NULL, '9', "Credit", '32345678'),
(NULL, '5', "Credit", '31234567'),
(NULL, '1', "Credit", '31234567'),
(NULL, '1', "Credit", '29012345'),
(NULL, '2', "Text", '29012345'),
(NULL, '1', "Credit", '28901234'),
(NULL, '1', "Cash", '28901234'),
(NULL, '2', "Cash", '25678901'),
(NULL, '2', "Cash", '25678901'),
(NULL, '2', "Credit", '38459281'),
(NULL, '3', "Debit", '19012345'),
(NULL, '3', "Cash", '25678901'),
(NULL, '1', "Debit", '17890123'),
(NULL, '5', "Debit", '87654321'),
(NULL, '7', "Debit", '15678901'),
(NULL, '4', "Credit", '90123456'),
(NULL, '1', "Cash", '89012345');
